...
public class M1User {
    ...
    M1User(int runs1,int id,int runs2,int wicket2,int wicket1,String name1,String name2,String name3,String name4){
    ...
    M1User(int aInt, int aInt0, int aInt1, int aInt2, String string, String string0) {
